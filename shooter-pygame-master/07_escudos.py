...
class Player(pygame.sprite.Sprite):
	def __init__(self):
		super().__init__()
		self.image = pygame.image.load("assets/Uribito.png").convert()
...
meteor_images = []
meteor_list = ["assets/Campe.png", "assets/rodo.png", "assets/Petro.png", "assets/Cl.png",
				"assets/meteorGrey_med1.png", "assets/meteorGrey_med2.png", "assets/meteorGrey_small1.png", "assets/meteorGrey_small2.png",
				"assets/Cuchi.png", "assets/meteorGrey_tiny2.png"]
